...
use App\Http\Controllers\Registro1Controller;
...
Route::get('/gestionUsuario', [RegisterController::class, 'create'])->middleware('auth.admin')->name('gestionUsuario.index');

Route::post('/gestionUsuario', [RegisterController::class, 'store'])->name('gestionUsuario.store');

Route::get('/logout', [SessionController::class, 'destroy'])->middleware('auth')->name('tpsLogin.destroy');

Route::get('/admin',[Admincontroller::class, 'index'])->middleware('auth.admin')->name('admin.index');

//listar
Route::get('/gestionUsuario', [RegisterController::class, 'index'])->middleware('auth.admin')->name('gestionUsuario.index');
...
//Route::get('/registros', [registro1Controller::class, 'index'])->name('registros.index');

Route::resource('/registros', registro1Controller::class);

/*Route::resources([
    'Registro1'=> Registro1Controller::class,
    'Vehiculo' => VehiculoController::class,
    'Persona' => PersonaController::class,
    'Estacionamiento' => EstacionamientoController::class
